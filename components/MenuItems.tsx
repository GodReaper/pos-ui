          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-3">
            {filtered.map((item) => (
              <button
                ...
                className="group flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950/80 px-3 py-2 text-left text-xs transition-colors hover:border-sky-600 hover:bg-slate-900"
              >
                <div>
